...
-keep class com.dineplan.dinefly.data.** { *; }
-keep class com.dineplan.dinefly.data.model.** { *; }
-keep class com.dineplan.dinefly.data.model.waiters.** { *; }
-keep interface com.dineplan.dinefly.data.** { *; }
-keep interface com.dineplan.dinefly.data.model.** { *; }
-keep interface com.dineplan.dinefly.data.model.waiters.** { *; }
-keepclassmembers interface com.dineplan.dinefly.data.** { *; }
-keepclassmembers interface com.dineplan.dinefly.data.model.** { *; }
-keepclassmembers interface com.dineplan.dinefly.data.model.waiters.** { *; }
-keeppackagenames com.dineplan.dinefly.data.**
-keeppackagenames com.dineplan.dinefly.data.model.**
-keeppackagenames com.dineplan.dinefly.data.model.waiters.**
