 ...
 */
@Entity
public class WaiterOrderComboItem
{
    ...
    ToOne<WaiterOrderSaleItem> combo;
    ...
    public WaiterOrderComboItem(final WaiterOrderSaleItem combo, final ComboGroup comboGroup, final ComboItem comboItem, final WaiterMenuItem item, final int qty)
    {
        dateAdded = new Date();
        dateChanged = new Date();
        status = WaiterOrderItemStatus.DraftImmediate;
        ...
        potionAmount = comboItem != null ? (float) comboItem.getPrice() : 0;
        this.combo.setTarget(combo);
    }
