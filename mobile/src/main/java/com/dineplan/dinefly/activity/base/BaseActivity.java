package com.dineplan.dinefly.activity.base;
...
import com.dineplan.dinefly.event.permission.PermissionGrantEvent;
import com.dineplan.dinefly.event.system.ForceFinishActivityEvent;
import com.dineplan.dinefly.event.system.GenericErrorEvent;
import com.dineplan.dinefly.fragment.base.BaseFragment;
...
public class BaseActivity extends MvpAppCompatActivity
{
     ...
     * @param description optional dialog content
     */
    public void showBlockingIndeterminateProgressDialog(final boolean cancelable, final int title, final int description)
    {
        showBlockingIndeterminateProgressDialog(cancelable, getString(title), getString(description));
    }
    ...
    protected void showError(final Throwable err)
    {
        showMessage(err.getMessage());
    }

    protected void showError(final Throwable err, DialogCloseCallback callback)
    {
        showMessage(err.getMessage(), callback);
    }
