...
import com.dineplan.dinefly.component.SquareRelativeLayout;
 ...
 * Date: 08/10/2017
 */
public class MenuItemSquareView extends SquareRelativeLayout
{

    @BindView(R.id.waiterMenuItemPicture)
    ImageView picture;

    @BindView(R.id.waiterMenuItemPrice)
    TextView price;

    @BindView(R.id.waiterMenuItemName)
    TextView title;

    @BindView(R.id.waiterMenuItemAlias)
    TextView alias;

    public MenuItemSquareView(final Context context)
    {
        super(context);
        configure();
    }

    public MenuItemSquareView(final Context context, final AttributeSet attrs)
    {
        super(context, attrs);
        configure();
    }

    public MenuItemSquareView(final Context context, final AttributeSet attrs, final int defStyleAttr)
    {
    ...
    @TargetApi(21)
    public MenuItemSquareView(final Context context, final AttributeSet attrs, final int defStyleAttr, final int defStyleRes)
    {
    ...
    {
        LayoutInflater.from(getContext()).inflate(R.layout.waiters_view_menuitem_square, this, true);
